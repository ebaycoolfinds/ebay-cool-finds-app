...
const App = () => {
    ...
    const contentPillars = useMemo(() => [
        ...
        { id: 'ebay_hidden_gems', name: 'Joyas Ocultas y Coleccionables', prompt: 'A dramatic close-up of a rare, intricate, or surprisingly valuable collectible item (e.g., a limited edition action figure, a vintage comic book, a unique stamp, an antique pocket watch) subtly lit to highlight its details, resting on a display stand or a simple, elegant surface. Focus on the item\'s craftsmanship and rarity. Dark, moody lighting. Realistic photo.' },
        ...
        { id: 'transforming_spaces', name: 'Transformando Espacios', prompt: 'A well-composed shot of a unique home decor item (e.g., a vintage lamp, a quirky sculpture, a unique wall hanging) prominently displayed in a modern, inviting living space. Focus on how the item adds character and personality to the room. Natural, inviting light. Realistic photo.' },
        ...
        { id: 'retro_gadgets_tech', name: 'Gadgets y Tecnología Retro', prompt: 'A sleek, modern desk setup featuring a prominent, functional retro gadget (e.g., a vintage video game console, an old-school Walkman, a classic rotary phone) next to a contemporary laptop or smartphone, highlighting the blend of old and new tech. Clean, focused lighting. Realistic photo.' },
        { id: 'stories_in_objects', name: 'Historias en Objetos', prompt: 'A close-up of a unique antique item (e.g., a weathered leather-bound journal, an old compass with intricate engravings, a vintage globe) resting on a textured, aged surface, with a subtle play of light and shadow emphasizing its history. Focus on the item\'s implied past and unique character. Moody, artistic lighting. Realistic photo.' },
    ], []);
